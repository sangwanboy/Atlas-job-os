    ...
    <div className="fixed inset-0 z-[9999] overflow-y-auto bg-white dark:bg-slate-900">
      <div className="w-full min-h-screen flex flex-col">
        ...
        {isLoading ? (
          ...
          <div className="rounded-xl border border-dashed border-slate-300 dark:border-white/10 bg-slate-50/40 dark:bg-white/5 p-6 text-center text-muted text-sm mx-6 flex flex-col items-center gap-3">
