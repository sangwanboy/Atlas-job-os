...
const QUOTES = [
  {
    text: "Atlas found me 3 senior roles I hadn't seen anywhere else. The CV scoring is scary accurate.",
    name: "James T.",
  ...
  {
    text: "Scored 47 jobs in my first session. Saved me hours of mindless scrolling on LinkedIn.",
    name: "Tom W.",
